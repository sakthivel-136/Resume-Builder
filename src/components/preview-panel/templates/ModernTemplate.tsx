          ...
          <div key={key}>
            {projects.map((p, idx) => (
              <div key={p.id || idx} className={shared.entryBlock} style={{ fontSize: isLeftCol ? '0.9em' : 'inherit' }}>
                  ...
                  {p.problemStatement && (
                    <div style={{ fontSize: isLeftCol ? '0.9em' : 'inherit', marginTop: '4px', marginBottom: '2px' }}>
                      <strong>Problem:</strong> {p.problemStatement}
                    </div>
                  )}
                  {p.proposedSolution && (
                    <div style={{ fontSize: isLeftCol ? '0.9em' : 'inherit', marginTop: '2px', marginBottom: '4px' }}>
                  ...
                  {(p.githubUrl || p.liveUrl) && (
                    <div style={{ display: 'flex', gap: '12px', fontSize: isLeftCol ? '0.85em' : '0.9em', marginTop: '4px', marginBottom: '2px' }}>
