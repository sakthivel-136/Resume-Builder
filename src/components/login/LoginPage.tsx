      ...
      <div className={styles.content}>
        ...
        <div className={styles.features}>
          ...
          <div className={styles.featureCard}>
            ...
            <div className={styles.featureTitle}>Multiple Profiles</div>
            <div className={styles.featureDesc}>
              Create and manage multiple resume profiles. Swap data instantly
            </div>
          </div>
            ...
            <div className={styles.importContent}>
              ...
              <div className={styles.importSteps}>
                <div className={styles.importStep}>
                  ...
                  Open the builder and click <b>Export JSON</b> from the top left panel to save your current resume data as a <code>.json</code> backup.
                </div>
                <div className={styles.importStep}>
                  <span className={styles.importBadge}>Step 2</span>
                  Next time, click <b>Import JSON</b> and select that file — all your data loads and updates instantly in the UI editing panels!
                </div>
                <div className={styles.importStep}>
                  <span className={styles.importBadge}>Tip</span>
                  Use <b>Duplicate Profile</b> to create multiple versions of your resume for different job positions!
                </div>
