...
export function createSampleResume(): ResumeData {
  return {
    ...
    phone: '+91 6374052055',
    email: 'c.sakthivel1.3.2006@gmail.com',
    linkedin: 'linkedin.com/in/sakthivel-c',
    github: 'github.com/sakthivel-136',
    ...
    skillGroups: [
      { id: generateId(), category: 'Languages & Frameworks', values: 'Python, SQL, FastAPI, Flask, Next.js 14, PostgreSQL, Supabase, Tailwind CSS, RESTful APIs, JWT, Flutter' },
      { id: generateId(), category: 'Tools & Access Control', values: 'Git, GitHub, RBAC' },
      { id: generateId(), category: 'Machine Learning', values: 'TensorFlow, XGBoost, Random Forest, Gemini 1.5 Pro' },
      { id: generateId(), category: 'IoT & Protocols', values: 'ESP32/Arduino, MQTT' },
    ],
    experience: [
      {
        id: generateId(),
